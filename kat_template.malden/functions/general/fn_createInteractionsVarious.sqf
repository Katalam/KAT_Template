...
private _gunbagCondition = {
    ...
    !((_gunbag getVariable ["ace_gunbag_gunbagWeapon", []]) isEqualTo []) && {!(_weapon call ace_gunbag_fnc_isMachineGun)} && {!(primaryWeapon _player isEqualTo "")};
};
...
private _gunbagCode = {
    ...
    [5, _player, {
        ...
        ([_player, _weapon] call ace_common_fnc_getWeaponState) params ["", "", "_addedMags", "_addedAmmo"];
        {
    ...
    }, {}, localize "STR_ACE_Gunbag_OffGunbag", {true}] call ace_common_fnc_progressBar;
};
