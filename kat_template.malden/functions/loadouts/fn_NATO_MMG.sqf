...
/*
 * Author: Katalam
 * Loadout - NATO: Machinegunner [DLC]
 */
...
/** PRIMARY */
_player addWeapon WEAPON_MMG;
WEAPON_MMG_STUFF apply {_player addWeaponItem [WEAPON_MMG, _x]};

for "_i" from 1 to 2 do {
    _player addItemToVest WEAPON_MMG_AMMO;
...
switch (["GearLevel", 0] call BISFUNC(getParamValue)) do {
    case 1: {
        _player addPrimaryWeaponItem FLASHLIGHT(WEAPON_MMG_NVG);
        _player addItemToUniform "ACE_Flashlight_XL50";
    };
    case 2: {
        _player addPrimaryWeaponItem LASER(WEAPON_MMG_NVG);
        _player addItemToUniform "ACE_Flashlight_XL50";
